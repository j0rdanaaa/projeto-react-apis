        ...
        {isLoading ? (
          ...
          <PokeCard colorbcg={getColors(pokeData.types[0].type.name)}>
            <PokeContainer>
              ...
              <TypeDiv>
                <PokeType
                  colorbackground={typeColors(pokeData.types[0].type.name)}
                >
                  <PokeTypeImage src={getTypes(pokeData.types[0].type.name)} />
                  {pokeData.types[0].type.name}{" "}
                </PokeType>
                {pokeData.types[1] ? (
                  <PokeType2
                    colorbackground2={typeColors(pokeData.types[1].type.name)}
                  >
                    <PokeTypeImage
                      src={getTypes(pokeData.types[1]?.type.name)}
                    />
              ...
              <ContainerDetail>
                <PokeDetails onClick={() => onClickPokeDetail()}>
                  Detalhes
                </PokeDetails>
              </ContainerDetail>
            </PokeContainer>
